...
def test_rate_equations_linear_one(
    ...
    Note that parameters `linear_parameters` and `linear_structure` are not defined in this file. They are fixtures defined in the file `conftest.py`: pytest makes fixtures in this file available anywhere in the same directory. See https://docs.pytest.org/en/6.2.x/fixture.html#conftest-py-sharing-fixtures-across-multiple-files.
